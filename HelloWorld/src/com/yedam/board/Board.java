...
public class Board {
	...
	public String showInfo() { // 목록 보여 줄 메소드. 
		String yyyymmdd = (writeDate.getYear()+ 1900) + "-" + (writeDate.getMonth() + 1) + "-" + writeDate.getDate() + " " + writeDate.getHours()+ ":" + writeDate.getMinutes() + ":" + writeDate.getSeconds();
