...
public class ReplyDAO extends DAO{
	...
	// 일정삭제.
	public boolean deleteEvent(String title, String sd) {
		getConn();
		String sql = "delete from tbl_events where title = ? and start_date = ?";
		try {
